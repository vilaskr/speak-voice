...
export const Footer: React.FC<FooterProps> = ({ onAdminRouteClick, onOpenSetupModal }) => {
  return (
    <footer className="border-t border-slate-200 bg-white px-4 sm:px-8 py-3.5 flex flex-col sm:flex-row items-center justify-between text-xs text-slate-500 gap-3 flex-shrink-0">
      <div className="flex gap-2 sm:gap-4 items-center flex-wrap justify-center sm:justify-start">
        <span>&copy; 2026 SpeakSafe Platform</span>
        <span className="text-slate-300">&bull;</span>
        <span className="text-slate-600 font-medium">100% Anonymous</span>
        <span className="text-slate-300">&bull;</span>
      ...
      <div className="flex gap-4 items-center flex-wrap justify-center sm:justify-end">
        ...
        <div className="flex gap-3.5 border-l border-slate-200 pl-4 items-center">
          {/* Instagram Logo Link */}
          <a
          ...
          {onOpenSetupModal && (
            <button
              ...
              className="hover:text-indigo-600 transition-colors cursor-pointer text-slate-500 font-medium ml-1"
          ...
          {onAdminRouteClick && (
            <button
              ...
              className="hover:text-indigo-600 transition-colors cursor-pointer flex items-center gap-1 text-slate-500 font-medium"
